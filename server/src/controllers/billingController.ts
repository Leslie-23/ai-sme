    ...
    plans: [
      {
        ...
        interval: null,
        highlight: false,
        tagline: 'Start tracking a small shop or demo account.',
        features: [
      ...
      },
      {
        ...
        interval: 'monthly',
        highlight: true,
        tagline: 'For shop owners who want AI summaries, imports, and unlimited operating records.',
        features: [
          'Everything in Free',
          'Unlimited products & sales',
          'Owner Assistant for sales, stock, and profit questions',
      ...
      },
      {
        ...
        interval: 'monthly',
        highlight: false,
        tagline: 'For pilots and growing shops that need setup help and data portability.',
        features: [
          'Everything in Pro',
          'Priority email support',
          '30-minute assisted onboarding call',
